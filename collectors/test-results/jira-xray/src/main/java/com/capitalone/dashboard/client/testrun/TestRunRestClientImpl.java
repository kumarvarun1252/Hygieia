...
import com.capitalone.dashboard.client.core.json.gen.TestRunJsonGenerator;
...
public class TestRunRestClientImpl extends AbstractAsynchronousRestClient implements TestRunRestClient {
    ...
    //TODO: ADD IMPLEMENTATION
    public Promise<com.capitalone.dashboard.client.api.domain.Comment> getComment(Long testRunId) {
        throw new IllegalArgumentException("NOT IMPLEMENTED YET");
    }
    //TODO: ADD IMPLEMENTATION
